    ...
    <section className=' bg-[#192038]  py-10'> 
      <Container>
        <Flex className=''>
          ...
          <Image src={logo2} className='w-[180px] h-[25px] mb-5 '/>
          <ul className='flex flex-col gap-y-2'>
            ...
            <li><List text='Authenticity' className=' border-b border-white pb-2'/></li>
          ...
          <div className='w-3/12 my-3 pl-15'>
          <Subtitle title='TOP CATEGORIES' className='mb-4'/>
          <ul className='flex flex-col gap-y-2'>
        ...
        <div className='w-2/12 my-3'>
          <Subtitle title='QUICK LINKS' className='mb-4'/>
          <ul className='flex flex-col gap-y-2'>
        ...
        <div className='w-2/12 my-3'>
          <Subtitle title='ALL ABOUT BEAUTY' className='mb-4'/>
          <ul className='flex flex-col gap-y-2'>
        ...
        <div className='w-3/12 my-3'>
          <Subtitle title='HELP' className='mb-4'/>
          <ul className='flex flex-col gap-y-2'>
         ...
         <div className='border-t border-white my-5'>
            <Flex className='pt-5 justify-center gap-x-6'>
