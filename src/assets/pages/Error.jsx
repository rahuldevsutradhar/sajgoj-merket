    ...
    <section>
      <Container>
        <Flex className='items-center '>
          <Image src={error}/>
          <div>
            <h1 className='font-bold font-mon text-[32px]'>UH OH! You are lost.</h1>
            <p className='font-mon mb-3 text-[#b0b2b3]'>The page you are looking for does not exist. Click the button below to go back to the homepage.</p>
