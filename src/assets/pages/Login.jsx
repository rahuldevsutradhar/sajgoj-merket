...
const Login = () => {
  return (
    <section className='pb-[30px] pt-[20px]'>
      <Container>
        <Flex className='border  md:p-6 w-[360px] sm:w-[608px] md:w-[900px] h-[253px] sm:h-[300px] md:h-[450px] mx-auto   md:items-center '>
          ...
          <div className='mx-9 md:mx-0 my-auto md:my-0'>
            ...
            <ButtonOne text='Login' className='bg-black text-white text-center'/>
          </div>
        </Flex>
